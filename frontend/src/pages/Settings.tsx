                ...
                {activeSection === 'plan' && (
                  <div className="bg-blue-600 rounded-3xl p-8 text-white relative overflow-hidden shadow-xl shadow-blue-600/20">
                    <div className="relative z-10">
                      <h4 className="text-2xl font-black mb-2 uppercase tracking-tight">Plan Premium</h4>
                      <p className="text-blue-100 mb-6">Tu suscripción está activa hasta el 15/06/2026</p>
                      <button className="bg-white text-blue-600 px-6 py-2.5 rounded-xl font-bold text-sm hover:bg-blue-50 transition-all">
